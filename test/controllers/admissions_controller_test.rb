...
class AdmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admission" do
    assert_difference('Admission.count') do
      post admissions_url, params: { admission: { admit_id: @admission.admit_id, admit_type: @admission.admit_type } }
    end
  ...
  test "should update admission" do
    patch admission_url(@admission), params: { admission: { admit_id: @admission.admit_id, admit_type: @admission.admit_type } }
